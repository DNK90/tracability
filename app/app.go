...
import (
	"encoding/json"
	"github.com/dnk90/tracability/x/tracability"
	"io"
	"os"
...
type NewApp struct {
	*bam.BaseApp
	...
	farmsKeeper    tracability.Keeper
...
// NewtracabilityApp is a constructor function for tracabilityApp
func NewInitApp(
	...
	app.farmsKeeper = tracability.NewKeeper(app.cdc, keys[tracability.StoreKey])
	...
	app.mm = module.NewManager(
		...
		slashing.NewAppModule(app.slashingKeeper, app.accountKeeper, app.stakingKeeper),
		tracability.NewAppModule(app.farmsKeeper),
